...
| `hosts/media-proxy/` | メディアプロキシ。proxy(Caddy), media-proxy([media-proxy-rs](https://github.com/chan-mai/media-proxy-rs))。`media-proxy.misskey.blue`として公開し、misskey.blue以外のインスタンスからも参照する |
